...
tabsContainer.addEventListener('click', function (e) {
  ...
  tabsContainer.forEach(c => c.classList.remove('operations__content--active'));
...
const headerObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  // height of navigation % and rem does not work only px
...
// message.innerHTML =
//   'We use cokkie for improved functionality and analytics. <button class = "btn btn--close-cookie">Got it</button>';

// // it can put multiple
// // put it as first of child
// // header.prepend(message);
// // put it as end of child
