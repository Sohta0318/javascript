...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    //In each call, remaining time to UI
    labelTimer.textContent = `${min}: ${sec}`;
    // when 0second stop timer and log out
    if (time === 0) {
      clearInterval(timer);
...
console.log(Math.max(5, 18, 23, 7, 10));
console.log(Math.max(5, 18, '23', 7, 10));
console.log(Math.max(5, 18, '23px', 7, 10));

console.log(Math.min(5, 18, 23, 7, 10));
...
console.log(45281263618648214668664924823648296846);
console.log(45281263618648214668664924823648296846n);
console.log(BigInt(45281263));

// Operating
console.log(10000n + 10000n);
console.log(32765423766238643n * 1000n);
// console.log(Math.sqrt(16n));

const huge = 239729378283974n;
const num = 23;
...
const now = new Date();
console.log(now);
console.log(new Date('Fri Sep 10 2021 17:01:40'));
...
// SetTimeout
const ingredients = ['olives', 'spinatch'];
...
if (ingredients.includes('spinatch')) {
  clearTimeout(pizzaTimer);
}
// let answer = prompt('ingredients');
// if (answer.includes('spinatch')) {
//   clearTimeout(pizzaTimer);
// }
